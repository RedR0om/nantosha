...
const logoPreview = ref<string | null>(props.brand.logo);
...
const removeLogo = () => {
    form.logo = null;
    logoPreview.value = props.brand.logo;
};
...
<template>
    <AppLayout>
        <Head :title="`Edit Brand: ${brand.name} - Admin`" />
        ...
        <div class="py-8 bg-gray-50 dark:bg-gray-900 min-h-screen">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm p-6">
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Edit Brand</h1>
                            ...
                            <div>
                                ...
                                <label class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 dark:border-gray-600 border-dashed rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                    <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                        ...
                                        <p class="text-sm text-gray-600 dark:text-gray-400">Click to upload new logo</p>
                                    </div>
                                    <input
                                        id="logo"
                                        type="file"
