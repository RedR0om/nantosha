...
class AdminProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'capsules_per_bottle' => 'nullable|integer|min:1',
            'bottle_pricing_tiers' => 'nullable|array',
            'bottle_pricing_tiers.*.capsules' => 'required|integer|min:1',
            'bottle_pricing_tiers.*.price' => 'required|numeric|min:0',
            'bottle_pricing_tiers.*.price_per_capsule' => 'nullable|numeric|min:0',
